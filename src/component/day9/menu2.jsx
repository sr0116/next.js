      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="max-w-sm bg-white rounded-2xl shadow-lg">
          ...
          <div className="p-4 text-center">
            <h1 className="text-2xl font-extrabold mb-2">페퍼로니 피자</h1>
            <p className="mb-2 text-gray-500">바삭한 도우 + 치즈 + 페퍼로니</p>
            <p className="text-lg font-bold text-gray-400">₩ 15,900</p>
          </div>
